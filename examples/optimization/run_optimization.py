...
def main():
    ...
    parser = argparse.ArgumentParser(description="Run parameter optimization for Local Deep Research")
    parser.add_argument("query", help="Research query to optimize for")
    parser.add_argument("--output-dir", default="optimization_results", help="Directory to save results")
    ...
    parser.add_argument("--trials", type=int, default=30, help="Number of parameter combinations to try")
    parser.add_argument("--mode", choices=["balanced", "speed", "quality", "efficiency"], 
                        default="balanced", help="Optimization mode")
    parser.add_argument("--weights", help="Custom weights as JSON string, e.g., '{\"quality\": 0.7, \"speed\": 0.3}'")
    ...
    print(f"Starting optimization ({args.mode} mode) - results will be saved to {output_dir}")
