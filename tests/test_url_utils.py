...
class TestNormalizeOllamaUrl:
    """Test cases for the normalize_ollama_url function."""
    ...
    def test_localhost_without_scheme(self):
        ...
        assert normalize_ollama_url("[::1]:11434") == "http://[::1]:11434"
        assert normalize_ollama_url("0.0.0.0:11434") == "http://0.0.0.0:11434"
    ...
    def test_external_host_without_scheme(self):
        ...
        assert normalize_ollama_url("api.example.com") == "https://api.example.com"
    ...
    def test_well_formed_urls(self):
        ...
        assert (
            normalize_ollama_url("http://localhost:11434") == "http://localhost:11434"
        )
        assert (
            normalize_ollama_url("https://example.com:11434")
            == "https://example.com:11434"
        ...
        assert (
            normalize_ollama_url("http://192.168.1.100:11434")
    ...
    def test_urls_with_double_slash_prefix(self):
        ...
        assert normalize_ollama_url("//localhost:11434") == "http://localhost:11434"
        assert (
            normalize_ollama_url("//example.com:11434") == "https://example.com:11434"
        )

    def test_empty_or_none_url(self):
        """Test handling of empty or None URLs."""
        assert normalize_ollama_url("") == "http://localhost:11434"
        assert normalize_ollama_url(None) == "http://localhost:11434"

    def test_url_with_path(self):
        """Test URLs with paths."""
        assert (
            normalize_ollama_url("localhost:11434/api") == "http://localhost:11434/api"
        )
        assert (
            normalize_ollama_url("example.com/api/v1") == "https://example.com/api/v1"
        )
