...
from ..services.research_service import start_research, get_research_status, cancel_research
...
def api_get_config():
    ...
    public_config = {
        ...
        'llm_provider': current_app.config.get('LLM_CONFIG', {}).get('provider', 'ollama'),
        'search_tool': current_app.config.get('SEARCH_CONFIG', {}).get('search_tool', 'auto'),
        'features': {
