...
def llm_settings():
    ...
    settings = (
        ...
        .filter(Setting.type == SettingType.LLM)
    ...
    return render_template(
        "llm_settings.html", settings_by_category=settings_by_category
    )
...
def search_settings():
    ...
    settings = (
        db_session.query(Setting)
        .filter(Setting.type == SettingType.SEARCH)
        .order_by(Setting.category, Setting.name)
        .all()
    )
    ...
    return render_template(
        "search_settings.html", settings_by_category=settings_by_category
    )
...
def app_settings():
    ...
    settings = (
        db_session.query(Setting)
        .filter(Setting.type == SettingType.APP)
        .order_by(Setting.category, Setting.name)
        .all()
    )
    ...
    return render_template(
        "app_settings.html", settings_by_category=settings_by_category
    )
...
def report_settings():
    ...
    settings = (
        db_session.query(Setting)
        .filter(Setting.type == SettingType.REPORT)
        .order_by(Setting.category, Setting.name)
        .all()
    )
    ...
    return render_template(
        "report_settings.html", settings_by_category=settings_by_category
    )
